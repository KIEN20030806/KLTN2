...
class RFID:
    ...
    def __init__(self, i2c, address=_I2C_ADDRESS, asw=None, suppress_warnings=False):
        ...
        self.uid_map = {
            ...
            "54:D9:96:EE": "KHI.wav",
            "84:D9:96:EE": "HO.wav",
            "34:F0:95:EE": "SUTU.wav",
            "14:ED:95:EE": "HUOU.wav",
            "E4:7C:95:EE": "TRUNG.wav",
            "BE:19:A8:B9": "ECHCON.wav",
            "FE:1C:A8:B9": "NN.wav",
            "B5:69:65:72": "NN2.wav",
            "2E:3E:AC:B9": "NN4.wav",
            "4E:41:AC:B9": "ECH.wav",
    ...
    def remove_card(self, listname):
        ...
        if uuid in self.lists[listname]:  
            ...
            if not self.lists[listname]:  
                ...
                self.save_list(listname)  # Lưu lại danh sách nếu còn phần tử
    ...
    def uid_wav(self, uid):
        return self.uid_map.get(uid, "Unknown")  # trả về tên nếu có, không có trả về "Unknown"
